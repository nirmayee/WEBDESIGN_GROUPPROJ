                ...
                <Row>
                    <Col xs={12} lg={4}>
                        <Card className="home-cards">
                          ...
                          <Card.Body>
                            ...
                            <Button className="btn-go-to" variant="primary" href="#food">Go to Recipes</Button>
                          </Card.Body>
                        </Card>
                    </Col>
                    <Col xs={12} lg={4}>
                    <Card className="home-cards" >
                          ...
                          <Card.Body>
                            ...
                            <Button className="btn-go-to" variant="primary" href="#travel">Go to Backpackers</Button>
                          </Card.Body>
                        </Card>
                    </Col>
                    <Col xs={12} lg={4}>
