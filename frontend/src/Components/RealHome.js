                ...
                <Row>
                    <Col xs={12} lg={4}>
                        <Card className="home-cards">
                          <Card.Img variant="top" src="images/foodCard.png" style={{height:'312px',width:'312px'}} />
                          <Card.Body>
                    ...
                    <Col xs={12} lg={4}>
                    <Card className="home-cards" >
                          <Card.Img variant="top" src="images/travelCardn4.jpg" style={{height:'312px',width:'312px'}} />
                          <Card.Body>
                    ...
                    <Col xs={12} lg={4}>
                    <Card className="home-cards" >
                          <Card.Img variant="top" src="images/blogCardn3.jpg" style={{height:'312px',width:'312px'}} />
                          <Card.Body>
